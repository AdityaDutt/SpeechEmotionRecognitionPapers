...
- Integrating Multimodal Information in Large Pretrained Transformers, 2020 [Link](https://aclanthology.org/2020.acl-main.214.pdf)

- Learning Better Representations for Audio-Visual Emotion Recognition with Common Information, 2020 [Link](https://www.mdpi.com/2076-3417/10/20/7239)

- Audio-visual emotion fusion (AVEF): A deep efficient weighted approach, 2019 [Link](https://mmlab.snu.ac.kr/~mchen/min_paper/2019/2019-InformationFusion-3-AVEF.pdf)

- Bimodal Emotion Recognition Based on Convolutional Neural Network, 2019 [Link](https://dl.acm.org/doi/pdf/10.1145/3318299.3318347)
...
- Audio-visual emotion recognition using deep transfer learning and multiple temporal models, 2017 [Link](https://dl.acm.org/doi/pdf/10.1145/3136755.3143012)

- Audio-Visual Emotion Recognition in Video Clips, 2017 [Link](https://www.researchgate.net/publication/317487334_Audio-Visual_Emotion_Recognition_in_Video_Clips)

- Learning Affective Features With a Hybrid Deep Model for Audio–Visual Emotion Recognition, 2017 [Link](http://www.jdl.link/doc/2011/201919_T-CSVT%20ID-2283.pdf)
...
- Fusion Approaches for Emotion Recognition from Speech Using Acoustic and Text-Based Features, 2020 [Link](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9054709)

- WISE: Word-Level Interaction-Based Multimodal Fusion for Speech Emotion Recognition, 2020 [Link](http://www.interspeech2020.org/index.php?m=content&c=index&a=show&catid=261&id=382)
...
- Multimodal Speech Emotion Recognition Using Audio and Text, 2018 [Link](https://arxiv.org/pdf/1810.04635.pdf)
...
- A REVIEW PAPER ON EMOTION RECOGNITION, 2020 [Link](https://www.ijeast.com/papers/472-483,Tesma412,IJEAST.pdf)

- A survey of facial expression recognition based on deep learning, 2020. [Link](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9248180)
